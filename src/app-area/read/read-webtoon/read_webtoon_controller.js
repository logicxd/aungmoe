...
async function loadReadPage(req, res) {
    ...
    var webtoonImages = findWebtoonImages(html)
    // TODO: abstract these 3 lines into a single method
...
function findWebtoonImages(html) {
    // TODO: can consolidate in the loadReadPage and remove from findTextTitle
